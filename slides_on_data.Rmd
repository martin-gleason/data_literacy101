...
* address the elephant in the room: Why do we think we don't need data?
...
```{rd correct_viz, include = TRUE, echo = FALSE, message = FALSE, fig.align='center', fig.height = 5, fig.width = 10, message = FALSE}

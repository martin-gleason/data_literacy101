...
* ask for purpose
* language, which comes in many forms, is critical to the exchange of good information
---
...
???
This is presentation mode. Wherein my notes are collected. 
---
.center[# Expectations]
...
* Take the alloyed time  to note how you use personal **or** probation data.

???
Additional instructions: 
* Give the room 5-15 minutes to discuss how they use data. 
* Can include a musical track.
* On a white board, write down audience responses
* if no response, go to the next slide and ask for people to raise their hand
---
class: center
# Sharing is Caring
...
* Excercise: Revisit the *How do you use data.*
...
--
  ...
  + *Why not take all the available data?*
...
* remember Median = mean in normal distro; in income, use median over mean. Sometimes in categorical/Qualitative data, use median over mean
---
class:center
# Total Height
...
* *Spreadsheets*
  + Also how we store and transform most data

???
# Database v Spreadsheet:
* DB relational, SP flat file
* DB hard, SP easy
* DB limited access, SP everyone has excel
...
* Prescriptive: What is the best course?
---
...
* [Intro to Statistics](https://www.datacamp.com/tracks/learn-statistics-with-r) 
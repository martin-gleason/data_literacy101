...
---
class: center
# Word Cloud: Your Registration Data<sup>2</sup>

```{r, wordcloud, include = TRUE, message = FALSE, warning = FALSE, echo = FALSE, fig.align='center', fig.height=5, fig.width=5}
source("wordcloud.R")

```

.footnote[
#####**From a total of `r length(unique(email))` registrants.**]
